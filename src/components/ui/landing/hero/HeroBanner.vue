      ...
      <v-col>
        ...
        <v-row>
          <v-col>
            ...
            <h2 class="text-h6 text-sm-h5 secondary--text mt-4 text-center">
              We produce awesome software to move the average person forward and
              amazing games to drive the mind of our community.
            </h2>
